                ...
                render={({ field }) => (
                  <FormItem className="col-span-12 lg:col-span-10">
                    <FormControl className="m-0 p-0">
                      <Input
                        className="bolder-0 outline-none focus-visible:ring-0
              ...
              <div key={idx}>
                {/* <div
                  className={`rounded-lg p-4 ${
                    message.role === "user" ? "bg-violet-500/10" : "bg-blue-500/10"
                  }`}
                > */}
                <div className={cn(
                  ...
                  <ReactMarkdown
                      components={{
                        pre: ({node, ...props}) => (
                          <div className="overflow-auto w-full my-2 bg-black/15 p-2 rounded-lg">
                            <pre {...props} />
                          </div>
                        ),
                        code: ({node, ...props}) => (
